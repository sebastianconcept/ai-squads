...
show_usage() {
  ...
  echo "  agent <squad_name>    Create a new agent using .squads-ai/templates/agent-template.md"
    echo ""
    echo "Examples:"
...
## Source of Truth
This squad is defined in \`.squads-ai/squads/$normalized_name.md\`
...
## Squad Reference
For complete squad definition and capabilities, see: \`@~/.squads-ai/squads/$normalized_name.md\`
EOF
...
## Source of Truth
This agent is defined in \`.squads-ai/agents/$normalized_name.md\`
...
## Agent Reference
For complete agent definition and capabilities, see: \`@~/.squads-ai/agents/$normalized_name.md\`
EOF
...
- \`$resource_file\` - References \`.squads-ai/[type]/$resource_file\`" "$readme_file"
...
if [ "$RESOURCE_TYPE" == "squad" ]; then
    ...
    echo "  📁 Squad definition: .squads-ai/squads/$normalized_name.md"
    echo "  📁 Cursor reference: .cursor/rules/$normalized_name-squad.md"
    echo ""
    print_status "Next steps:"
    echo "  1. Edit .squads-ai/squads/$normalized_name.md to customize squad details"
    ...
    echo ""
    print_status "Created files:"
    echo "  📁 Agent definition: .squads-ai/agents/$normalized_name.md"
    echo "  📁 Cursor reference: .cursor/rules/$normalized_name-agent.md"
    echo ""
    print_status "Next steps:"
    echo "  1. Edit .squads-ai/agents/$normalized_name.md to customize agent details"
    echo "  2. Update the reference file with specific information"
