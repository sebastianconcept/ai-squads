...
setup_project_docs() {
    ...
    if [ ! -f "$docs_dir/README.md" ]; then
        cp ".squads-ai/templates/projects/docs/README.md" "$docs_dir/README.md"
    ...
    for subdir in "${subdirs[@]}"; do
        ...
        local template_dir=".squads-ai/templates/projects/docs/$subdir"
...
setup_all_project_docs() {
    ...
    local projects_dir=".squads-ai/projects"
...
update_project_templates() {
    ...
    local project_template=".squads-ai/templates/projects/project.md"
...
' "$project_template"
    ...
    local readme_template=".squads-ai/templates/projects/README.md"
...
list_docs() {
    local project="$1"
    local docs_dir=".squads-ai/projects/$project/docs"
