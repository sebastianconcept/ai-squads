...
**Date:** {date}  
**Purpose:** Questions to close before or during implementation so the plan is unambiguous for implementers.
...
- [PRD.md](./PRD.md) — User stories and goals
- [SPECS.md](./SPECS.md) — Technical approach
- [prd.json](./prd.json) — Execution plan
