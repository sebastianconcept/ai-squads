...
# Creates: .squads-ai/squads/web-development.md
...
# Creates: .squads-ai/agents/data-analyst.md
...
cp -r templates/projects .squads-ai/projects/[PROJECT_NAME]
...
1. **Edit the main file** (`.squads-ai/squads/[name].md` or `.squads-ai/agents/[name].md`)
...
1. **Copy project templates** to `.squads-ai/projects/[PROJECT_NAME]/`
