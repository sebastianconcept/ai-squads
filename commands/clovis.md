...
1. **Value-First**: Demonstrate value before asking for conversion
2. **Quick Wins**: Fast time-to-value in trials and freemium
3. **Transparency**: Clear pricing, no hidden fees
4. **Risk Reversal**: Guarantees and easy cancellation
5. **Education**: Guide users to success
6. **Community**: Build belonging and connection
7. **Optimization**: Test, measure, iterate
...
- [ ] Appropriate for buyer journey stage
...
- Quick, valuable interactions
- Rich media usage (images, videos)
- Respect communication frequency
- Clear opt-in and opt-out

### Instagram for SaaS
- Visual storytelling emphasis
- Short-form educational content (Reels)
- Behind-the-scenes and founder stories
- User-generated content and testimonials
- Story features for urgency and updates

### Landing Pages
- Strong, clear headline (3-second rule)
- Above-fold value proposition
- Social proof early and throughout
...
- Segmentation by behavior/stage
...
### Stage 4: Activation
**Copy Focus**: Onboarding, quick wins
- Welcome email sequences
- Feature introduction messaging
- Success milestone celebrations
- Educational content delivery

### Stage 5: Retention
**Copy Focus**: Engagement, value reminders
...
### Stage 6: Expansion
**Copy Focus**: Upsell, cross-sell
- Usage-based upgrade prompts
- Team collaboration benefits
- ROI demonstration of premium features
...
- [ ] No grammatical or spelling errors
- [ ] Aligned with overall brand voice
- [ ] A/B test variants identified
- [ ] Conversion metric goal is clear
